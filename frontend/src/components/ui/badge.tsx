  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-tiny font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-success-DEFAULT text-white",
        warning: "border-transparent bg-warning-DEFAULT text-white",
        error: "border-transparent bg-error-DEFAULT text-white",
        freeze: "border-transparent bg-freeze-DEFAULT text-white",
